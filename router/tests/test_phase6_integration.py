...
def _make_success_result(command_type: str, data: dict | None = None) -> RouterResult:
    """Create a success router result for testing."""
    return RouterResult(
        success=True,
        message="ok",
...
def _make_error_result(command_type: str, error_code: str = "invalid") -> RouterResult:
    """Create an error router result for testing."""
    return RouterResult(
        success=False,
...
class TestSinglePlayerWorkflow:
    ...
    def test_single_start_presents_game_state(self):
        ...
        msg = present_router_result("123", result)
...
class TestGroupGameWorkflow:
    ...
    def test_group_lobby_displays_participants(self):
        ...
        msg = present_router_result("456", result)
