...
def test_tutorial_success_returns_start_game_keyboard_for_private_chat():
    text, kb = _present_success(
        result=RouterResult(success=True, message="ok", command_type="tutorial", data={"chat_type": "single"}),
...
def test_tutorial_success_returns_start_game_keyboard_for_group_chat():
    text, kb = _present_success(
        result=RouterResult(success=True, message="ok", command_type="tutorial", data={"chat_type": "group"}),
