...
from app.game_client import HttpGameServiceClient
from app.routing import DeduplicatingCommandProcessor
from app.routing import GameCommandHandlers
from app.routing import RouterCommandDispatcher
from app.routing import RouterPipeline
...
def create_app(settings: Settings) -> RouterApp:
    configure_logging(settings.log_level)
    logger.info("Router application initialized")
    ...
    dispatcher = RouterCommandDispatcher()
...
def main() -> None:
    ...
    try:
        ...
        logger.info("Router shutdown requested by user")